...
class RRTagCollectionViewCell: UICollectionViewCell {
    ...
    func initContent(tag: Tag) {
        ...
        isSelectedTag = tag.isSelectedTag
        textContent.backgroundColor = UIColor.clearColor()
        self.textContent.layer.backgroundColor = (self.isSelectedTag == true) ? colorSelectedTag.CGColor : colorUnselectedTag.CGColor
        self.textContent.textColor = (self.isSelectedTag == true) ? colorTextSelectedTag : colorTextUnSelectedTag
    }
